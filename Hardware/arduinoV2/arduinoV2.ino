...
#define zx03_th_both 500
#define ldr_th_both 40
...
//Right
Stepper right(steps, 3, 7);
//Left
Stepper left(steps, 8, 9);
...
void loop() {
  ...
  lightvalue = analogRead(lightsen);
        ...
        switch (cur_data_header) {
          case GET_SERVER_DATA_RESULT: {
              ...
              if (a == 0) {
                ...
                avaiable = 1;
                Serial.print("SW PRESSED IN LOOP");
                Serial.println(avaiable);
              }
...
//                  //Motor Forward
//                  Serial.println("Beforeee Forward");
                  Serial.println("Forward");
                  robot_forward();
//                  if ( lightvalue < zx03_th) {
//                    Serial.println("Left kkkkkkkkkkkkkk");
//                    left.step(10);
//                  }
//
//                  if ( ldrvalue < ldr_th ) {
//                    Serial.println("Right kkkkkkkkkkkkkk");
//                    right.step(10);
...
//                    Motor Back
                ...
                if (ldrvalue < ldr_th_both and lightvalue < zx03_th_both) {
                  Serial.print("STOP IN FRONT OF THE ROOM!!!!!!!");
                  robot_stop();
                  project_data.motor = 0;
